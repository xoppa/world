package com.xoppa.android.loaders.model.g3d;
...
import com.badlogic.gdx.graphics.g3d.loaders.BaseModelLoader;
...
public class G3dxLoader {
	...
	public static class G3dxStillModelLoader extends BaseModelLoader<StillModel, AssetLoaderParameters<StillModel>> {
		public G3dxStillModelLoader(FileHandleResolver resolver) {
			super(resolver);
		}

		@Override
		protected StillModel load(FileHandle file, AssetLoaderParameters<StillModel> parameters, ObjectMap<SubMesh, String> dependencies) {
			return G3dxLoader.loadStillModel(file, dependencies);
		}
	}

	public static class G3dxKeyframedModelLoader implements KeyframedModelLoader {
		@Override
		public KeyframedModel load (FileHandle handle, ModelLoaderHints hints) {
			return G3dxLoader.loadKeyframedModel(handle);
		}
	}
	
	public static class G3dxSkeletonModelLoader implements SkeletonModelLoader {
		@Override
		public SkeletonModel load (FileHandle handle, ModelLoaderHints hints) {
			return G3dxLoader.loadSkeletonModel(handle);
		}
	}
}
